...
CPU_COUNTS="`grep -c ^processor /proc/cpuinfo`"
...
make -C OpenBLAS ONLY_CBLAS=1 DYNAMIC_ARCH=1 TARGET=NEHALEM USE_LOCKING=1 USE_THREAD=0 NUM_THREADS=$CPU_COUNTS all
